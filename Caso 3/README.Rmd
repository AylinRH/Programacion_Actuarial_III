...
### DESCRIPCÍON
Dentro de la base de datos, obtenida por la compañia telefonica Samsung, contiene las variables que describen el comportamiento bajo las diferentes actividades realizadas por el usuario  (especificamente 6), en 3 ejes. Estos están señalados por los vectores *X*,*Y* y *Z*.
